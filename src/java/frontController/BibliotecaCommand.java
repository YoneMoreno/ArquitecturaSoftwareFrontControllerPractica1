...
This commands aims to relate Carousel and Library
 ...
 * @author YonePC
 */
@WebServlet(name = "BibliotecaCommand", urlPatterns = {"/BibliotecaCommand"})
public class BibliotecaCommand extends FrontCommand {
