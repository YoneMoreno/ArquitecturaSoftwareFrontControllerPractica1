...
Our FrontServlet eaccepts commands, initializes them and executes them.

In addition it handles HTTPSession.

In addition it persists Course and Assessment being created in current session.
 */
package org;
